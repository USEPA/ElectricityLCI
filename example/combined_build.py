...
upstream_dict = electricitylci.write_upstream_process_database_to_dict(upstream_df)
...
#gen_plus_fuels = electricitylci.add_fuels_to_gen(gen_df,upstream_df, upstream_dict)
...
aggregate_dict = electricitylci.write_gen_fuel_database_to_dict(aggregate_df,upstream_dict,subregion="US")
