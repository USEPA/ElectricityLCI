...
df1 = pd.read_csv("Aggregated_tri1.csv",error_bad_lines=False)
df2 = pd.read_csv("Aggregated_tri2.csv",error_bad_lines=False)
df3 = pd.read_csv("Aggregated_tri3.csv",error_bad_lines=False)
df4 = pd.read_csv("Aggregated_tri4.csv",error_bad_lines=False)
...
df1.to_csv('Finaltriforimport1.csv')
df2.to_csv('Finaltriforimport2.csv')
df3.to_csv('Finaltriforimport3.csv')
df4.to_csv('Finaltriforimport4.csv')
