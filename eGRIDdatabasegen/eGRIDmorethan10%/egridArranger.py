# -*- coding: utf-8 -*-
"""
Created on Fri Aug  4 14:51:34 2017
...
df1 = pd.read_csv("Aggregated_LCI1.csv",error_bad_lines=False)
df2 = pd.read_csv("Aggregated_LCI2.csv",error_bad_lines=False)
df3 = pd.read_csv("Aggregated_LCI3.csv",error_bad_lines=False)
df4 = pd.read_csv("Aggregated_LCI4.csv",error_bad_lines=False)
...
df1.to_csv('FinalLCIforimport1.csv')
df2.to_csv('FinalLCIforimport2.csv')
df3.to_csv('FinalLCIforimport3.csv')
df4.to_csv('FinalLCIforimport4.csv')
