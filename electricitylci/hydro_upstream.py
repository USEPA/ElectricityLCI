...
def generate_hydro_emissions():
    ...
    FLOW_DICTIONARY={
        "co2 (kg)": {
            ...
            "Compartment_path": "emission/air","Compartment":"air"},
        "ch4 (kg)": {
            "FlowName": "Methane",
        ...
        "water use (m3)": {
            ...
            "Compartment_path": "resource/water","Compartment":"input"}
    }
    ...
    hydro_df.rename(
        columns={"value":"FlowAmount","NERC Region":"NERC"},
        inplace=True
    )
    ...
    hydro_df.loc[
        hydro_df["FlowName"]=="Water, fresh", "FlowAmount"] = hydro_df.loc[
            hydro_df["FlowName"]=="Waster, fresh", "FlowAmount"]*1000
    hydro_df["Unit"] = "kg"
