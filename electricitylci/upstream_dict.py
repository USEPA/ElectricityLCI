...
#        "SOLAR": "22: Utilities/2211: Electric Power Generation Transmission and Distribuion",
    ...
    if fuel_type is not "CONSTRUCTION":
        ar['processDocumentation']=process_doc_creation(process_type=f"{fuel_type.lower()}_upstream")
    elif fuel_type is "CONSTRUCTION":
        ar['processDocumentation']=process_doc_creation(process_type="plant_construction")
    ar["processType"] = "SYSTEM_PROCESS"
