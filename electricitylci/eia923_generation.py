...
def eia_download_extract(odd_year):
        ...
        eia = pd.read_excel('EIA923_Schedules_2_3_4_5_M_12_'+odd_year+'_Final_Revision.xlsx',sheet_name = 'Page 1 Generation and Fuel Data')
        ...
        eia = eia.drop([4])       
        eia.to_csv('EIA923_Schedules_2_3_4_5_M_12_'+odd_year+'_Final_Revision.csv')
        '''
        #Replace this read in with a check to see if EIA-923 has been processed
        eia = pd.read_csv('EIA923_Schedules_2_3_4_5_M_12_'+odd_year+'_Final_Revision.csv')
        ...
        #EIA_923_generation_data.to_csv('EIA923_Schedules_2_3_4_5_M_12_'+odd_year+'_Final.csv')
