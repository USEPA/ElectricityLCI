# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 13:13:45 2017
...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 27 17:59:55 2017
...
#Filling up of the General Information page
...
for row in fuellist.itertuples():
      if row[2] == Reg:
            ...
            '''
            inp1 = pd.read_csv("Aggregated_LCI1.csv", header=0, error_bad_lines=False)
            inp2 = pd.read_csv("Aggregated_LCI2.csv", header=0, error_bad_lines=False)
            inp3 = pd.read_csv("Aggregated_LCI3.csv", header=0, error_bad_lines=False)
            inp4 = pd.read_csv("Aggregated_LCI4.csv", header=0, error_bad_lines=False)
